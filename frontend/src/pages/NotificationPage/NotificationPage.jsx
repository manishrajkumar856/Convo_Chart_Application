...
const NotificationPage = () => {
  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-start px-80">
      <div className="w-full max-h-[90vh] overflow-hidden flex flex-col justify-start items-start  gap-3 mt-3 bg-[#efefefaa] px-20 py-5 mb-10 rounded-2xl text-[#575656]">
